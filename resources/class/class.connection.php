...
$db = Connection1("yujiservice");

function Connection1($database,$usr="root",$pass=""){
    $obj= new DBObject1("localhost",$database,$usr,$pass);
...
class DBObject1 {
	...
	function recordArray($sql,$params=array())
	{
	    ...
	    $this->query($sql,$params);
	    $this->fetchObject();
    	return ($this->next($this)); // devuelve un registro
	}
